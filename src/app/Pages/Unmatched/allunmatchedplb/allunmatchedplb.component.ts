...
@Component({
  selector: "app-allunmatchedplb",
  templateUrl: "./allunmatchedplb.component.html",
  styleUrls: ["./allunmatchedplb.component.css"],
})
export class AllunmatchedplbComponent implements OnInit, OnDestroy {
  constructor(
  ...
  public sSelectedUnmatchedPLBSearchBy: string = "Filename";
  ...
  ngOnInit() {
    try {
      ...
      if (
        ...
        if (this.searchfiltersvr.alluplbsfilter == true) {
          this.searchfiltersvr.files_mastererafileid = this.neraMasterFileid;
          this.sSearchText = this.searchfiltersvr.getalluplbssSearchText();
          this.sSelectedUnmatchedPLBSearchBy = this.searchfiltersvr.getalluplbssSearchBy();
  ...
  clearFilters() {
    try {
      ...
      this.sSearchText = "";
      this.sSelectedUnmatchedPLBSearchBy = "Filename";
      this.fbcFilterSearch.setValue(this.sSearchText);
      this.startDate = new Date();
      this.startDate.setMonth(this.startDate.getMonth() - 3);
      this.endDate = new Date();
  ...
  PLBExcelExport(args: any): void {
    try {
      ...
      new Workbook(workbook).toDataURL().then((dataUrl: string) => {
        ...
        this.api.insertActivityLog(
          "All Unmatched PLB exported excel",
          "All Unmatched PLB",
          "READ"
        );
        this.emailloading = false;
