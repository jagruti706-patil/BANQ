...
declare var $: any;
@Component({
  selector: "app-unprocesssplitfiles",
  templateUrl: "./unprocesssplitfiles.component.html",
  styleUrls: ["./unprocesssplitfiles.component.css"],
})
export class UnprocesssplitfilesComponent implements OnInit, OnDestroy {
  constructor(
  ...
  public sSelectedSplitStatus: string = "2";
  ...
  ngOnInit() {
    try {
      ...
      this.api.insertActivityLog(
        "Unprocessed Split Files List Viewed ",
        "Unprocess Split Files",
        "READ",
        this.neraMasterFileid
      );
      // } else {
