...
@Component({
  selector: "app-ftptransfer",
  templateUrl: "./ftptransfer.component.html",
  styleUrls: ["./ftptransfer.component.css"],
})
export class FtptransferComponent implements OnInit {
  constructor(
  ...
  public sSelectedDownloadfilter: string = "FTP Uploaded";
  ...
  public globalmessage: string =
    "ERA Files ready to download will begin appearing in the list below on and after 03/20.";
  ...
  public inputcomponentname: any = "FTP Transferred";
  ...
  OnDownloadSplitFile(Splitfilename, nerafileid, masterfileid) {
    try {
      ...
      FileSaver.saveAs(blob, Splitfilename);
  ...
  clearSplitFilters() {
    try {
      ...
      this.sSelectedDownloadfilter = "FTP Uploaded";
