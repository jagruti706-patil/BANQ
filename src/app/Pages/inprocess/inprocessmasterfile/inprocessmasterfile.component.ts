...
@Component({
  selector: 'app-inprocessmasterfile',
  templateUrl: './inprocessmasterfile.component.html',
  styleUrls: ['./inprocessmasterfile.component.css']
})
export class InprocessmasterfileComponent implements OnInit {
  constructor(
  ...
  public sSelectedMasterStatus: string = "0";
  ...
  ngOnInit() {
    try {
      ...
      this.api.insertActivityLog(
        "Inprocess Master Files List Viewed",
        "Inprocess Master Files",
        "READ"
      );
    } catch (error) {
